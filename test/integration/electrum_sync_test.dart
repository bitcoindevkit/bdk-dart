...
void main() {
  group('Electrum integration', () {
    test('sync, apply update, persist, and reload wallet state', () {
      ...
      try {
        ...
        printOnFailure('Checkpoint after sync height: $checkpointAfterHeight');
        ...
        printOnFailure('Reloaded checkpoint height: $reloadedCheckpointHeight');
        expect(
