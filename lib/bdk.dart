...
class Amount implements AmountInterface {
  ...
  Amount.fromSat(
    int satoshi,
            ...
            (status) => _UniffiLib.instance
                .uniffi_bdkffi_fn_constructor_amount_from_sat(satoshi, status),
            null) {
    _AmountFinalizer.attach(this, _ptr, detach: this);
  }
    ...
    return rustCall(
        (status) => BumpFeeTxBuilder.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_bumpfeetxbuilder_current_height(
                uniffiClonePointer(), height, status)),
        null);
  }
    ...
    return rustCall(
        (status) => BumpFeeTxBuilder.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_bumpfeetxbuilder_version(
                uniffiClonePointer(), version, status)),
        null);
  }
}
    ...
    return rustCall(
        (status) => CbfBuilder.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_cbfbuilder_configure_timeout_millis(
                uniffiClonePointer(), handshake, response, status)),
        null);
  }
    ...
    return rustCall(
        (status) => CbfBuilder.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_cbfbuilder_connections(
                uniffiClonePointer(), connections, status)),
        null);
  }
...
class CbfClient implements CbfClientInterface {
  ...
  Future<FeeRate> averageFeeRate(
    ...
    return uniffiRustCallAsync(
      ...
      _UniffiLib.instance.ffi_bdkffi_rust_future_poll_pointer,
      _UniffiLib.instance.ffi_bdkffi_rust_future_complete_pointer,
      _UniffiLib.instance.ffi_bdkffi_rust_future_free_pointer,
      FeeRate.lift,
      cbfExceptionErrorHandler,
    );
  }
    ...
    return rustCall(
        (status) => FfiConverterDouble64.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_electrumclient_estimate_fee(
                uniffiClonePointer(), number, status)),
        electrumExceptionErrorHandler);
  }
...
class EsploraClient implements EsploraClientInterface {
    ...
    return rustCall(
        (status) => BlockHash.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_esploraclient_get_block_hash(
                uniffiClonePointer(), blockHeight, status)),
        esploraExceptionErrorHandler);
  }
  ...
  Update sync_(
    ...
    return rustCall(
        (status) => Update.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_esploraclient_sync(uniffiClonePointer(),
                SyncRequest.lower(request), parallelRequests, status)),
        esploraExceptionErrorHandler);
  }
}
    ...
    return rustCall(
        (status) => FfiConverterString.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_psbt_spend_utxo(
                uniffiClonePointer(), inputIndex, status)),
        null);
  }
    ...
    return rustCall(
        (status) => TxBuilder.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_txbuilder_exclude_below_confirmations(
                uniffiClonePointer(), minConfirms, status)),
        null);
  }
...
class Wallet implements WalletInterface {
  ...
  bool markUsed(
    ...
    return rustCall(
        (status) => FfiConverterBool.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_wallet_mark_used(uniffiClonePointer(),
                FfiConverterKeychainKind.lower(keychain), index, status)),
        null);
  }
  ...
  AddressInfo peekAddress(
    ...
    return rustCall(
        (status) => FfiConverterAddressInfo.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_wallet_peek_address(uniffiClonePointer(),
                FfiConverterKeychainKind.lower(keychain), index, status)),
        null);
  }
  ...
  bool unmarkUsed(
    ...
    return rustCall(
        (status) => FfiConverterBool.lift(_UniffiLib.instance
            .uniffi_bdkffi_fn_method_wallet_unmark_used(uniffiClonePointer(),
                FfiConverterKeychainKind.lower(keychain), index, status)),
        null);
  }
}
...
class UniffiHandleMap<T extends Object> {
  ...
  T get(int handle) {
    ...
    if (obj == null) {
      _map.remove(handle);
      _strongRefs.remove(handle);
      throw UniffiInternalError(UniffiInternalError.unexpectedStaleHandle,
          "Handle not found (object was garbage collected)");
    }
    return obj;
  }
...
class _UniffiLib {
  ...
  late final void Function(
    ...
    Pointer<NativeFunction<UniffiRustFutureContinuationCallback>>,
    Pointer<Void>,
  ) ffi_bdkffi_rust_future_poll_pointer = _dylib.lookupFunction<
      Void Function(
        Pointer<Void>,
        Pointer<NativeFunction<UniffiRustFutureContinuationCallback>>,
        Pointer<Void>,
      ...
      void Function(
        ...
        Pointer<NativeFunction<UniffiRustFutureContinuationCallback>>,
        Pointer<Void>,
      )>("ffi_bdkffi_rust_future_poll_pointer");
  late final void Function(
    Pointer<Void>,
  ) ffi_bdkffi_rust_future_cancel_pointer = _dylib.lookupFunction<
      Void Function(
        Pointer<Void>,
      ),
      void Function(
        Pointer<Void>,
      )>("ffi_bdkffi_rust_future_cancel_pointer");
  late final void Function(
    Pointer<Void>,
  ) ffi_bdkffi_rust_future_free_pointer = _dylib.lookupFunction<
      Void Function(
        Pointer<Void>,
      ),
      void Function(
  ...
  late final Pointer<Void> Function(Pointer<Void>, Pointer<RustCallStatus>)
      ffi_bdkffi_rust_future_complete_pointer = _dylib.lookupFunction<
              Pointer<Void> Function(Pointer<Void>, Pointer<RustCallStatus>),
              Pointer<Void> Function(Pointer<Void>, Pointer<RustCallStatus>)>(
          "ffi_bdkffi_rust_future_complete_pointer");
  late final void Function(
    Pointer<Void>,
    Pointer<NativeFunction<UniffiRustFutureContinuationCallback>>,
    Pointer<Void>,
